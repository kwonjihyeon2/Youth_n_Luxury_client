  ...
  return (
    <S.Wrapper>
      <S.WrapperContents>
        ...
        <S.ReviewTable>
          <div>
            <S.TableBox>
              ...
              <S.TableRight>
                <S.UserInfo>{props.data?.fetchProduct.user.name}님</S.UserInfo>
                <div>{props.data?.fetchProduct.description}</div>
              </S.TableRight>
            </S.TableBox>
            <div>
              <S.TableLeft>별점평가</S.TableLeft>
              <Rate defaultValue={0} onChange={props.setReviewRate} />
            </div>
            <div>
              <S.TableLeft>
        ...
        <S.ButtonSection>
          <S.SubmitButton onClick={props.onClickSubmit}>완료</S.SubmitButton>
        </S.ButtonSection>
      </S.WrapperContents>
    </S.Wrapper>
  )
